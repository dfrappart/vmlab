...
variable "SshPublicKey" {
  type        = string
  description = "The SSH public key used to authenticate the admin user of the Virtual Machine. Must be in OpenSSH format."
  default     = ""
}

variable "DisablePasswordAuthentication" {
  type        = bool
  description = "Specifies whether password authentication should be disabled for SSH. Defaults to false."
  default     = true
}
